...
const SearchField: FC<Props> = ({
    onEnterPress, searchFieldTextInState, isSearchActive, updateSearchTextInState
}) => {
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        const shouldMakeRequest = e.key === 'Enter' && searchFieldValue && searchFieldValue.length > 1
    ...
    return (
        <TextField
            sx={{mb: 1, ml: 1}} fullWidth variant='standard'
